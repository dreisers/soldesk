...
비  번 : <%=request.getAttribute("r_upw") %><br>

아이디 : <%=session.getAttribute("s_uid") %><br>
비  번 : <%=session.getAttribute("s_upw") %><br>

아이디 : <%=application.getAttribute("a_uid") %><br>
비  번 : <%=application.getAttribute("a_upw") %><br>
<hr>

2) EL (표현언어) <br>
아이디 : ${requestScope.r_uid }<br>
비  번 : ${requestScope.r_upw }<br> 

아이디 : ${sessionScope.s_uid }<br>
비  번 : ${sessionScope.s_upw }<br> 

아이디 : ${applicationScope.a_uid }<br>
비  번 : ${applicationScope.a_upw }<br>
<hr>
